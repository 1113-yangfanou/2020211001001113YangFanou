			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<c:forEach var="o" items="orderList">
						...
						<td>${o.orderDate}</td>
						<%
							com.YangFanou.model.Order o=(com.YangFanou.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.YangFanou.dao.UserDao userDao=new com.YangFanou.dao.UserDao();
						...
						<%
							...
							String paymentType=com.YangFanou.model.Payment.findByPaymentId(con,n);
							 %>
